...
// original source - https://github.com/wagtail/wagtail/blob/stable/2.16.x/client/src/entrypoints/admin/hallo-plugins/hallo-wagtaillink.js
      ...
      addButton.on('click', () => {
        ...
        if (enclosingLink) {
          ...
          if (linkType === 'page' && parentPageId) {
            url =
              widget.options.pageChooser + parentPageId.toString() + '/';
